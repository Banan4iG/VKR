...
img_1 = np.array(Image.open("E:/Никита/ИС-118/Диплом/VKR/039.jpg").convert('L'))
img_2 = np.array(Image.open("E:/Никита/ИС-118/Диплом/VKR/135.jpg").convert('L'))
...
# 4) Сопоставление признаков фланн
